...
class QuarterbackTester:
    ...
    def test_scenario(self, scenario_name: str, test_payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _simulate_mcp_call(self, tool: Dict[str, Any], payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _simulate_http_call(self, tool: Dict[str, Any], payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def run_all_scenarios(self) -> Dict[str, Any]:
        ...
        for scenario in scenarios:
            ...
            print(f"{'✅' if result['success'] else '❌'} {scenario['name']}: {result['latency_ms']}ms")
        
        successful_tests = [r for r in results if r["success"]]
        success_rate = len(successful_tests) / len(results) if results else 0
        avg_latency = sum(r["latency_ms"] for r in successful_tests) / len(successful_tests) if successful_tests else 0
        p95_latency = sorted([r["latency_ms"] for r in successful_tests])[int(len(successful_tests) * 0.95)] if successful_tests else 0
