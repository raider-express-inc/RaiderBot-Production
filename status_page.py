        ...
        return [
            {
                ...
                "url": f"{self.config['functions_gateway_base']}/health",
...
"""
    ...
    <div class="service">
        ...
        {f"<p><strong>⚠️ Redirect Detected</strong></p>" if service.get('redirect_detected') else ""}
    </div>
"""
...
async def main():
    ...
    print(f"Services: {status_data['healthy_services']}/{status_data['total_services']} healthy")
