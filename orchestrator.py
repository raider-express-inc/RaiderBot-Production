...
class UnifiedOrchestrator:
            ...
            try:
                ...
                tools.append(
                    Tool(
                        ...
                        func=lambda query, server=server_name: self._execute_mcp_tool(
                            server, query
                        ),
                    )
                )
    ...
    async def execute_cross_platform_pipeline(
    ...
    async def _create_execution_plan(
        self, task: Dict[str, Any], servers: List[str]
    ) -> Dict[str, Any]:
    ...
    async def _execute_pipeline_step(self, step: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self._call_mcp_server(
                server_name, action, step.get("parameters", {})
            )
